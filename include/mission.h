...
struct Mission {
  ...
  // optional parameters
  int int_param = 0;         // X animals, X exhibits, balance thresholds
  double float_param = 0.0;  // rating thresholds

  int reward_amount;

  Mission(bool required, const std::string& description, MissionType type, int int_param = 0,
          double float_param = 0.0, int reward_amount = 0, bool end_of_day = false)
